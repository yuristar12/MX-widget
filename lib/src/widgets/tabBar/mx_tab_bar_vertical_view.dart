...
class MXTabBarVerticalView extends StatefulWidget {
  const MXTabBarVerticalView({
    Key? key,
  ...
  @override
  State<MXTabBarVerticalView> createState() => _MXTabBarVerticalViewState();
}

class _MXTabBarVerticalViewState extends State<MXTabBarVerticalView> {
  ...
  @override
  void didUpdateWidget(MXTabBarVerticalView oldWidget) {
